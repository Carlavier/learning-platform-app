...
export function LessonEditor() {
  ...
  const addApplication = () => {
    setApplications([
      ...applications,
      { title: '', description: '', displayOrder: applications.length }
    ]);
  };
  ...
  const updateChoice = (questionIndex: number, choiceIndex: number, field: keyof QuestionChoice, value: string | boolean | number) => {
    const updated = [...questions];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(lesson ? `Failed to update lesson: ${errorMessage}` : `Failed to create lesson: ${errorMessage}`);
    } finally {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <form id="lesson-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            {!lesson && (
              <DocumentUploader onAnalysisComplete={handleDocumentAnalysis} />
            )}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Optional: Enter a URL, paste an image, or drag & drop an image file for the lesson's thumbnail
                  </p>
                  {imageUrl && (
                    <div className="mt-2">
                      <img
                  ...
                  <div className="space-y-2">
                    ...
                    {isNewCategory ? (
                      ...
                      <Select value={category} onValueChange={handleCategoryChange} required>
                        ...
                        <SelectContent>
                          <SelectItem value="+ Add New Category">+ Add New Category</SelectItem>
                          {categories.map(cat => (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" onClick={addApplication} variant="outline" size="sm" className="gap-2">
                      ...
                      <CardContent className="pt-4 space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <MarkdownTextarea
                            ...
                            onChange={(value) => updateApplication(index, 'description', value)}
                      ...
                      <CardContent className="pt-4 space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          {question.choices.map((choice, cIndex) => (
                            <div key={cIndex} className="flex items-start gap-2 p-3 bg-gray-50 rounded-md">
                              <Checkbox
                                checked={choice.isCorrect}
                                onCheckedChange={(checked) => updateChoice(qIndex, cIndex, 'isCorrect', checked as boolean)}
                                className="mt-1"
                              />
                              <div className="flex-1 space-y-1">
                                <Label className="text-xs text-gray-600">Choice {cIndex + 1}</Label>
                                <Input
