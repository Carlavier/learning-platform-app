    ...
    <div className={`prose prose-slate max-w-none ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: (props) => (
            <h1 {...props} className="text-3xl font-bold mb-4 mt-6" />
          ),
          h2: (props) => (
            <h2 {...props} className="text-2xl font-bold mb-3 mt-5" />
          ),
          h3: (props) => (
            <h3 {...props} className="text-xl font-semibold mb-2 mt-4" />
          ),
          h4: (props) => (
            <h4 {...props} className="text-lg font-semibold mb-2 mt-3" />
          ),
          ul: (props) => (
          ...
          code: (props) => {
            ...
            return inline ? (
              ...
              <code {...props} className="block bg-gray-900 text-gray-100 p-4 rounded-lg my-4 overflow-x-auto font-mono text-sm" />
            );
          },
          pre: (props) => (
            <pre {...props} className="bg-gray-900 rounded-lg overflow-hidden my-4" />
          ),
          blockquote: (props) => (
